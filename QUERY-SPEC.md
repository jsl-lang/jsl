# JSL Query Language Spec

The JSL Query Language is a small language specially tailored for querying JSL
...
This document describes JSLQ `1.0.0`. It was released on September 11, 2021.

## Selectors

Selectors use selection operators to filter nodes that will be returned by an
API using JSLQ. The main differences between this and CSS selectors are the
...
JSLQ implementations MAY support a "map operator", `=>`, that allows selection
